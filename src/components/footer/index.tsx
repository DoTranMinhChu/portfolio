                    ...
                    <div className="flex justify-center">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-6 my-3">
                                <Link href={"https://www.facebook.com/profile.php?id=100010245436007"} className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"https://www.linkedin.com/in/tr%E1%BA%A7n-minh-chu-%C4%91%E1%BB%97-b32716242"} className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"https://github.com/DoTranMinhChu"} className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"mailto:dotranminhchu@gmail.com"} className="inline-flex items-center space-x-2 font-semibold text-white">
