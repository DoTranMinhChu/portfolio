                    ...
                    <div className="flex justify-center">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-6 my-3">
                                <Link href={"https://www.facebook.com/profile.php?id=100010245436007"} target="_blank" className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"https://www.linkedin.com/in/tr%E1%BA%A7n-minh-chu-%C4%91%E1%BB%97-b32716242"} target="_blank" className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"https://github.com/DoTranMinhChu"} target="_blank" className="inline-flex items-center space-x-2 font-semibold text-white">
                                ...
                                <Link href={"mailto:dotranminhchu@gmail.com"} target="_blank" className="inline-flex items-center space-x-2 font-semibold text-white">
                                    <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12c6.627 0 12-5.373 12-12S18.627 0 12 0zm.14 19.018c-3.868 0-7-3.14-7-7.018c0-3.878 3.132-7.018 7-7.018c1.89 0 3.47.697 4.682 1.829l-1.974 1.978v-.004c-.735-.702-1.667-1.062-2.708-1.062c-2.31 0-4.187 1.956-4.187 4.273c0 2.315 1.877 4.277 4.187 4.277c2.096 0 3.522-1.202 3.816-2.852H12.14v-2.737h6.585c.088.47.135.96.135 1.474c0 4.01-2.677 6.86-6.72 6.86z" fill="currentColor" /></g></svg>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div>
                                <div className="my-2">
                                    ...
                                    <OpenMoreButton className="text-xl font-bold ">
