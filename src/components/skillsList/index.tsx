        ...
        <>
            <div className="w-full mt-20 overflow-hidden" ref={outerBox}>
                <div className="flex justify-end px-3">
                    <svg className="w-12 h-12 p-2 m-1 bg-gray-800 rounded-full cursor-pointer hover:bg-gray-700" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" onClick={() => handleChangeSkill(-1)}>
